    ...
    <div class="error_new_bg pr">
      <div class="error_new_content">
        <div class="error_new pa">
          <div class="fl error_new_left"><img src="/image/error/404.png"></div>
          <div class="fl error_new_right">
            <div class="error_detail">
              <p class="error_p_title">哎呦~ 老司机居然累倒了!</p>
              <p class="error_p_con">※ 抱歉，您访问的页面出错啦！</p>
              <p class="error_p_con">※ 别急，工程师正在紧急处理，请稍后重试!</p>
            </div>
...
<style lang="scss" scoped>
  .error{
    ...
    .error_new_left {
      width: 56%;
      text-align: right;
      animation: desc_link ease-in-out 1.5s infinite;
    }
